...
internal static class AssemblyLoader
{
	...
	static AssemblyLoader()
	{
		...
		assemblyNames.Add("microsoft.identitymodel.clients.activedirectory", "costura.microsoft.identitymodel.clients.activedirectory.dll.compressed");
		assemblyNames.Add("newtonsoft.json", "costura.newtonsoft.json.dll.compressed");
		assemblyNames.Add("nlog", "costura.nlog.dll.compressed");
		assemblyNames.Add("qrcoder", "costura.qrcoder.dll.compressed");
	...
	public static void Attach()
	{
		...
		currentDomain.AssemblyResolve += delegate(object sender, ResolveEventArgs e)
		{
			...
			AssemblyName ResolveAssemblyassemblyName = new AssemblyName(e.Name);
